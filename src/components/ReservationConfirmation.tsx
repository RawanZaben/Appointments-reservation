...
const ReservationConfirmation: React.FC<ReservationConfirmationProps> = ({ xname, nameDoctor }) => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center">
            <div className="hidden sm:block" ref={downloadRef}>
                ...
                <button className='absolute items-center h-14 w-[200px] bg-[#D47782] rounded-lg text-xl text-white  font-bold shadow-md ml-[1050px]  -mt-[250px]' onClick={handleDownloadImage}>
                    لطباعه الموعد
                </button>
            </div>
            <div className="sm:hidden block" ref={downloadRef1}>
                ...
                <button className='absolute items-center mt-4 h-14 sm:w-[200px] w-[100px] bg-[#D47782] rounded-lg sm:text-xl text-sm text-white font-bold shadow-md ml-[150px] ' onClick={handleDownloadImage1}>
                    لطباعه الموعد
                </button>
            </div>
        </div>
